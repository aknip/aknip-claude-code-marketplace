...
import { CHATS_DELAYS } from '@/apps/main/config/animation-config'
      ...
      <Main fixed>
        <section className='flex h-full gap-6'>
          ...
          <div className='flex w-full flex-col gap-2 sm:w-56 lg:w-72 2xl:w-80'>
            <AnimatedSection delay={CHATS_DELAYS.listHeader}>
            ...
            <AnimatedSection delay={CHATS_DELAYS.chatList}>
          ...
          {/* Right Side */}
          {selectedUser ? (
            <AnimatedSection delay={CHATS_DELAYS.chatArea} className="flex-1">
              <div
                className={cn(
            ...
            <AnimatedSection delay={CHATS_DELAYS.chatArea} className="flex-1">
              <div
                className={cn(
                  'absolute inset-0 start-full z-50 hidden w-full flex-1 flex-col justify-center rounded-md border bg-card p-6 shadow-xs sm:static sm:z-auto sm:flex'
                )}
              >
