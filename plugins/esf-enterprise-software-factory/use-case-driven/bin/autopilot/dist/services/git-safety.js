 ...
 */
export async function createSafetyCommit(cwd, context) {
    // Stage all changes
 ...
 */
export async function ensureCleanWorkingTree(cwd, context, logger) {
 ...
 */
export async function getLatestCommit(cwd) {
 ...
 */
export async function getCommitsSince(cwd, since) {
