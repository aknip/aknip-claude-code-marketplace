...
Whenever a Shad or shadcn component is requested, route through the MCP server first. This ensures access to context-aware patterns, consistent styling, and prevents broken implementations.
...
- Prefer entire Ul blocks (e.g. login, dashboard, calendar) when they exist
