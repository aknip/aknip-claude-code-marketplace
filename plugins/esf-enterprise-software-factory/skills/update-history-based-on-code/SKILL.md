...
2. Aenderungen ausfuehren: `/esf:update-history-based-on-code --execute`
...
2. Aenderungen ausfuehren:
   /esf:update-history-based-on-code --execute
...
- `/esf:audit-milestone` — Check milestone readiness (structural audit)
