...
Run /esf:autopilot to start autonomous execution.
```
...
**If "Skip for now":** End with "Run /esf:checkpoints when you're ready."
...
```
Checkpoint remains pending. Run /esf:checkpoints when ready.
```
...
{N} checkpoints remaining. Run /esf:checkpoints to continue.
