...
description: Research implementation approaches for a phase. Spawned by /esf:plan-phase.
...
You are spawned by:
- `/esf:plan-phase` orchestrator (before planning)
...
From `/esf:discuss-phase`, contains:
