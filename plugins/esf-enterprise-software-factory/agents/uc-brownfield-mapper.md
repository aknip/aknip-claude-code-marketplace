...
### Sprint 1: Quick Detection (1-2 minutes)
...
### Sprint 2: Structure Analysis (2-3 minutes)
...
### Sprint 3: Pattern Extraction (3-5 minutes)
...
### Sprint 4: Report Generation (1-2 minutes)
...
2. Run `/esf:new-project` to start UC-driven development
3. During `/esf:plan-sprint`, this map will be automatically loaded
...
3. Recommend `/esf:new-project` to start UC-driven work
4. Note that map will auto-load during planning sprints
