---
name: uc-modeler
description: Create roadmap from use case hierarchy with phase assignments. Spawned by /esf:create-roadmap.
...
You are spawned by:
- `/esf:create-roadmap` orchestrator
...
Plan first phase: `/esf:plan-phase 1`
```
